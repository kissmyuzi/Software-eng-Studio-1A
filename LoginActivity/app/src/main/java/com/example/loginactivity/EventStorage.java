...
public class EventStorage { //this is meant to be as static as possible
    ...
    public static void addEvent(String name, String date, String location, String description) {
        events.add(new Event("1234", "1234", "blank", name, location, date, description));
    }
}
